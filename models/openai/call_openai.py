...
AUTOMATION_SYSTEM_PROMPT_TEMPLATE = (
    ...
    "- For time triggers: use {{ trigger: 'time', at: 'HH:MM:SS' }}.\n"
    "- For weekly schedules: add a condition with 'condition: time' and 'weekday:' list using ONLY 3-letter abbreviations: mon, tue, wed, thu, fri, sat, sun.\n"
    "  Example for every Tuesday at 7am:\n"
    "    triggers: [{{ trigger: 'time', at: '07:00:00' }}]\n"
    "    conditions: [{{ condition: 'time', weekday: ['tue'] }}]\n\n"
